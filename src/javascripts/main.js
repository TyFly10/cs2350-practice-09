...
function displayMovie(movie){
    ...
    <div class="card-footer text-muted">
      ...
      <div class="col"><strong>Rated: </strong>${movie.rating}</div>
...
document.querySelector('[type="search"]').onsubmit = searchMovies
document.querySelector("button").onsubmit = searchMovies
